"""VGGT-Omega panorama demo without bundle adjustment."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Pano360 stitching with VGGT-Omega (without bundle adjustment)"
    )
    parser.add_argument(
        "--image-folder",
        "--image_folder",
    ...
    parser.add_argument(
        ...
        dest="output_path",
        type=Path,
        default=PROJECT_ROOT / "result/result.jpg",
    )
    parser.add_argument(
        "--model-path",
        "--model_path",
